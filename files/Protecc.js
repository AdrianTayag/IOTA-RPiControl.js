...
//Zone Fault Triggers
const Z1 = new Gpio(25, 'in', 'both', {debounceTimeout: 5})
const Z2 = new Gpio(8, 'in', 'both', {debounceTimeout: 5})
const Z3 = new Gpio(7, 'in', 'both', {debounceTimeout: 5})
const Z4 = new Gpio(12, 'in', 'both', {debounceTimeout: 5})
const Z5 = new Gpio(16, 'in', 'both', {debounceTimeout: 5})
const Z6 = new Gpio(20, 'in', 'both', {debounceTimeout: 5})
const Z7 = new Gpio(21, 'in', 'both', {debounceTimeout: 5})
//Islanding Button
const ISL = new Gpio(24, 'in', 'both', {debounceTimeout: 5})
